...
def login():
    ...
    if(user=="" and mdp==""):
        ...
        cur = con.cursor()
        sql = "SELECT * FROM admin WHERE mail = %s AND  mot_passe = %s "
...
u = Label(window,text="Utilisateur:", font = ("Arial",14),bg="#091821", fg="white" )
...
um = Label(window,text="Mot de passe:", font = ("Arial",14),bg="#091821", fg="white" )
